...
export default function ProjectDetailsPage() {
    ...
    return (
        <main className="min-h-screen bg-[var(--background)] text-[var(--foreground)] relative overflow-hidden">
            ...
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[600px] opacity-10 blur-[120px] pointer-events-none" style={{ background: accent.gradient }} />
                ...
                <div className="container mx-auto max-w-7xl">
                    ...
                    <ScrollAnimate delay={100}>
                        <div className="flex flex-col items-center text-center max-w-4xl mx-auto mb-16">
                            ...
                            <h1 className="text-5xl md:text-7xl font-extrabold mb-6 tracking-tight bg-clip-text text-transparent py-2" style={{ backgroundImage: accent.gradient, WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
                                {project.title}
                            </h1>
                            
                            <p className="text-xl md:text-2xl text-[var(--foreground-secondary)] leading-relaxed font-light">
                                {project.tagline}
                            </p>
                        </div>
                    </ScrollAnimate>
                    ...
                    <ScrollAnimate delay={200}>
                        <div className="relative w-full aspect-[16/9] md:aspect-[21/9] rounded-[2rem] md:rounded-[3rem] p-1.5 md:p-2 mb-24 group/image cursor-pointer hover:scale-[1.02] transition-transform duration-700" onClick={() => setIsImageFullScreen(true)}>
                            {/* Animated Glowing Border */}
                            <div className="absolute inset-0 rounded-[2rem] md:rounded-[3rem] opacity-50 group-hover/image:opacity-100 transition-opacity duration-700" style={{ background: accent.gradient, filter: 'blur(20px)' }} />
                            <div className="absolute inset-0 rounded-[2rem] md:rounded-[3rem] opacity-80" style={{ background: accent.gradient }} />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
                        <ScrollAnimate direction="left" delay={100}>
                            <div className="h-full p-8 md:p-10 rounded-[2rem] bg-[var(--background-secondary)] border border-white/5 hover:border-white/15 transition-colors relative overflow-hidden group">
                                <div className="absolute top-0 left-0 w-full h-1 opacity-20 group-hover:opacity-100 transition-opacity" style={{ background: accent.gradient }} />
                                <div className="mb-6 flex items-center gap-4">
                                    <div className="w-12 h-12 rounded-2xl bg-white/5 flex items-center justify-center text-[var(--foreground-secondary)] group-hover:text-white transition-colors border border-white/5">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-24">
                        <ScrollAnimate direction="left" delay={300}>
                            <div className="h-full p-8 md:p-10 rounded-[2rem] bg-[var(--background-secondary)] border border-white/5 hover:border-white/15 transition-colors">
                                <h3 className="text-xl font-bold text-white mb-8 tracking-wide">TECH STACK</h3>
                        ...
                        <ScrollAnimate direction="right" delay={400}>
                            <div className="h-full p-8 md:p-10 rounded-[2rem] bg-[var(--background-secondary)] border border-white/5 hover:border-white/15 transition-colors">
                                <h3 className="text-xl font-bold text-white mb-8 tracking-wide">KEY IMPACT</h3>
                    ...
                    <ScrollAnimate delay={500}>
                        <div className="w-full rounded-[2rem] bg-[var(--background-secondary)] border border-white/5 p-8 md:p-12 overflow-hidden relative">
                            {/* Subtle background glow for architecture */}
                            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[400px] opacity-10 blur-[100px] pointer-events-none" style={{ background: accent.primary }} />
                            
                            <div className="relative z-10">
                                <div className="text-center mb-12">
                                    <h3 className="text-3xl font-bold text-white tracking-tight mb-4">System Architecture</h3>
                                ...
                                <div className="p-4 md:p-8 rounded-2xl bg-[#0a0a0f]/50 border border-white/5 backdrop-blur-sm overflow-x-auto">
                                    <ArchitectureDiagram
